...
//	@BeforeMethod (alwaysRun = true, groups ="fail")
...
//		changePass.preCondition("0962370612", "Hoaithu*2811");
	...
	@Test (description = "Change Password Unsuccessfully When leaving fields blank", dataProvider = "Change Password Unsuccessfully When Leaving Fields Blank", priority = 3, groups="validation" )
	...
	@Test (description = "Validate Password Is Hidden", priority = 4,groups="validation")
