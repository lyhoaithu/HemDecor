...
@Test(description = "Verify Order ID at All Status", dataProvider ="Verify Order ID")
...
@Test(description = "Verify Order ID at Chờ Xác Nhận - COD Status", dataProvider ="Verify Order ID")
...
@Test(description = "Verify Order ID at Chờ Xác Nhận - Banking Status", dataProvider ="Verify Order ID")
...
@Test(description = "Verify Order ID at Đang Chuẩn Bị Hàng Status", dataProvider ="Verify Order ID")
...
@Test(description = "Verify Order ID at Đang Giao Hàng Status", dataProvider ="Verify Order ID")
public void verifyOrderIDAtDangGiaoHangStatus(String query1, String query2, String query3, String query4, String query5, String query6, String query7) throws ClassNotFoundException, SQLException, UnsupportedEncodingException {
	...
	String expectedResult= getValueFromDatabase(query5, 1);
	String actualResult=null;
	if(expectedResult.equals("[]")) {
		 actualResult= driver.findElement(adminOrderPage.lblMessage).getText();
		 assertEquals(actualResult, "Không Có Kết Quả Trùng Khớp");
...
@Test(description = "Verify Order ID at Đã Hoàn Thành Status", dataProvider ="Verify Order ID")
...
@Test(description = "Verify Order ID at Đã Hủy Status", dataProvider ="Verify Order ID")
...
@Test(description = "Validate navigating to order details page")
...
@Test(description = "Validate Search Order Successfully", dataProvider = "Search Order Successfully Data")
public void searchOrderSuccessfully(String keyword, String query) throws ClassNotFoundException, SQLException {
	...
	String actualResult= Arrays.deepToString(getDataFromTableColumn(adminOrderPage.lblOrderID));
	String expectedResult= getValueFromDatabase(query, 1);
	assertEquals(actualResult, expectedResult);
}
...
@Test(description = "Validate Search Order Successfully", dataProvider = "Search Order Fail Data")
...
@Test(description = "Validate cancel order successfully")
...
@Test(description = "Validate cancel order fail")
...
@Test(description = "Validate change single order status successfully")
...
@Test(description = "Validate changing order status by clicking on Chuyển Trạng Thái button")
...
@Test(description = "Validate changing order status when order status is 'Đã Hoàn Thành'")
